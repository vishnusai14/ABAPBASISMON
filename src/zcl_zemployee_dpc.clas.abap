class ZCL_ZEMPLOYEE_DPC definition
  public
...
protected section.
  ...
  methods ZC_EMPLOYEEFULL_CREATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_ZEMPLOYEE_MPC=>TS_ZC_EMPLOYEEFULLTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_EMPLOYEEFULL_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_EMPLOYEEFULL_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_EMPLOYEEFULL_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZEMPLOYEE_MPC=>TT_ZC_EMPLOYEEFULLTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods ZC_EMPLOYEEFULL_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
CLASS ZCL_ZEMPLOYEE_DPC IMPLEMENTATION.
...
*&* This class has been generated on 03.05.2026 16:27:03 in client 001
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZEMPLOYEE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA zc_employeefull_create_entity TYPE zcl_zemployee_mpc=>ts_zc_employeefulltype.
...
*-------------------------------------------------------------------------*
*             EntitySet -  ZC_EmployeeFull
*-------------------------------------------------------------------------*
     WHEN 'ZC_EmployeeFull'.
*     Call the entity set generated method
    zc_employeefull_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = zc_employeefull_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = zc_employeefull_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zc_employeefull_get_entity TYPE zcl_zemployee_mpc=>ts_zc_employeefulltype.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          zc_employeefull_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zc_employeefull_get_entity
                         es_response_context = es_response_context
          ).

        IF zc_employeefull_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zc_employeefull_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZEMPLOYEE_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA zc_employeefull_get_entityset TYPE zcl_zemployee_mpc=>tt_zc_employeefulltype.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      zc_employeefull_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = zc_employeefull_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = zc_employeefull_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zc_employeefull_update_entity TYPE zcl_zemployee_mpc=>ts_zc_employeefulltype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          zc_employeefull_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = zc_employeefull_update_entity
          ).
       IF zc_employeefull_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = zc_employeefull_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_ZC_EMPLOYEEFULL_1 TYPE zc_employeefull ##NEEDED. " reference for where-used list

    DATA(lv_sadl_xml) =
               |<?xml version="1.0" encoding="utf-16"?>| &
               |<sadl:definition xmlns:sadl="http://sap.com/sap.nw.f.sadl" syntaxVersion="" >| &
               | <sadl:dataSource type="CDS" name="ZC_EMPLOYEEFULL" binding="ZC_EMPLOYEEFULL" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="ZC_EmployeeFull" dataSource="ZC_EMPLOYEEFULL" maxEditMode="RO" exposure="TRUE" >| &
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20260503162648
               iv_uuid              = 'ZEMPLOYEE'
               io_context           = me->mo_context ).
  endmethod.


  method ZC_EMPLOYEEFULL_CREATE_ENTITY.
  ...
  method ZC_EMPLOYEEFULL_UPDATE_ENTITY.
