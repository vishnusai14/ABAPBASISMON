class ZCL_ZBASIS_BG_JOB_MON_MPC definition
  public
...
CLASS ZCL_ZBASIS_BG_JOB_MON_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZBASIS_BG_JOB_MON_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260602063836'.                  "#EC NOTEXT
