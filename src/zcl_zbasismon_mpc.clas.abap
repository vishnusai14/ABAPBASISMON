class ZCL_ZBASISMON_MPC definition
  public
...
CLASS ZCL_ZBASISMON_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZBASISMON_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260606065712'.                  "#EC NOTEXT
