class ZCL_ZBASISMON_02_DPC definition
  public
...
protected section.
  ...
  methods BGJOBLOGDETAILSS_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZBASISMON_02_MPC=>TT_BGJOBLOGDETAILS
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZBASISMON_02_DPC IMPLEMENTATION.
...
*     Call the entity set generated method
    bgjobdetailsset_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = bgjobdetailsset_create_entity
    ).
...
*-------------------------------------------------------------------------*
*             EntitySet -  BgJobDetailsSummarySet
*-------------------------------------------------------------------------*
     WHEN 'BgJobDetailsSummarySet'.
*     Call the entity set generated method
    bgjobdetailssumm_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = bgjobdetailssumm_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = bgjobdetailssumm_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*     Call the entity set generated method
    bgjoblogdetailss_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = bgjoblogdetailss_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = bgjoblogdetailss_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
      when 'BgJobDetailsSummarySet'.
*     Call the entity set generated method
     bgjobdetailssumm_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*     Call the entity set generated method
          bgjobdetailssumm_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = bgjobdetailssumm_get_entity
                         es_response_context = es_response_context
          ).

        IF bgjobdetailssumm_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = bgjobdetailssumm_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*-------------------------------------------------------------------------*
   WHEN 'BgJobDetailsSummarySet'.
*     Call the entity set generated method
      bgjobdetailssumm_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = bgjobdetailssumm_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = bgjobdetailssumm_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*-------------------------------------------------------------------------*
      WHEN 'BgJobDetailsSummarySet'.
*     Call the entity set generated method
          bgjobdetailssumm_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = bgjobdetailssumm_update_entity
          ).
       IF bgjobdetailssumm_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = bgjobdetailssumm_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method BGJOBDETAILSSET_CREATE_ENTITY.
  ...
  method BGJOBDETAILSSET_DELETE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBDETAILSSET_DELETE_ENTITY'.
  ...
  method BGJOBDETAILSSET_GET_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBDETAILSSET_GET_ENTITY'.
  ...
  method BGJOBDETAILSSET_UPDATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBDETAILSSET_UPDATE_ENTITY'.
  ...
  method BGJOBDETAILSSUMM_CREATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBDETAILSSUMM_CREATE_ENTITY'.
  ...
  method BGJOBDETAILSSUMM_DELETE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBDETAILSSUMM_DELETE_ENTITY'.
  ...
  method BGJOBDETAILSSUMM_GET_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBDETAILSSUMM_GET_ENTITY'.
  ...
  method BGJOBDETAILSSUMM_UPDATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBDETAILSSUMM_UPDATE_ENTITY'.
  ...
  method BGJOBLOGDETAILSS_CREATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBLOGDETAILSS_CREATE_ENTITY'.
  ...
  method BGJOBLOGDETAILSS_DELETE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBLOGDETAILSS_DELETE_ENTITY'.
  ...
  method BGJOBLOGDETAILSS_GET_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBLOGDETAILSS_GET_ENTITY'.
  ...
  method BGJOBLOGDETAILSS_UPDATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'BGJOBLOGDETAILSS_UPDATE_ENTITY'.
