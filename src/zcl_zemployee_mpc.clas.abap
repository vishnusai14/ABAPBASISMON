class ZCL_ZEMPLOYEE_MPC definition
  public
...
public section.
  ...
  types:
   TS_ZC_EMPLOYEEFULLTYPE type ZC_EMPLOYEEFULL .
  types:
   TT_ZC_EMPLOYEEFULLTYPE type standard table of TS_ZC_EMPLOYEEFULLTYPE .

  constants GC_ZC_EMPLOYEEFULLTYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZC_EmployeeFullType' ##NO_TEXT.
...
CLASS ZCL_ZEMPLOYEE_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZEMPLOYEE_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20260503162645'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20260503162647'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20260503162648'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZEMPLOYEE' )
